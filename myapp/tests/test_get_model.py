...
def test_get_model_not_found(client, get_counter_value):
    ...
    # 에러 카운트가 증가했는지 확인
    counter_value = get_counter_value('errors', {'type': 'get_model_not_found'})
    assert counter_value == 1

def test_get_model_missing_hash(client, get_counter_value):
